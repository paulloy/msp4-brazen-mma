"""
Django settings for brazen_mma project.
...
WSGI_APPLICATION = 'brazen_mma.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'brazen-martial-arts'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'brazen.martial.arts@example.com'
else:
